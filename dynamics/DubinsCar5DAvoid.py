...
class DubinsCar5DAvoid:
    ...
    def dynamics(self, t, state, uOpt, dOpt):
        x_1_dot = hcl.scalar(0, "x_1_dot")
        x_2_dot = hcl.scalar(0, "x_2_dot")
        x_3_dot = hcl.scalar(0, "x_3_dot")
        x_4_dot = hcl.scalar(0, "x_4_dot")
        x_5_dot = hcl.scalar(0, "x_5_dot")

        x_1_dot[0] = -state[3] + state[4] * hcl.cos(state[2]) + uOpt[0] * state[1]
        x_2_dot[0] = state[4] * hcl.sin(state[2]) - uOpt[0] * state[0]
        x_3_dot[0] = dOpt[0] - uOpt[0]
        x_4_dot[0] = uOpt[1] 
        x_5_dot[0] = dOpt[1]

        return (x_1_dot[0], x_2_dot[0], x_3_dot[0], x_4_dot[0], x_5_dot[0])
