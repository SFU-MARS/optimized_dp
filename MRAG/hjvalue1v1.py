...
grids = Grid(np.array([-1.0, -1.0, -1.0, -1.0]), np.array([1.0, 1.0, 1.0, 1.0]), 4, np.array([45, 45, 45, 45])) # original [45, 45, 45, 45]
...
np.save('/localhome/hha160/optimized_dp/MRAG/1v1AttackDefend_speed1.npy', result)
# np.save('1v1AttackDefend_g30_speed1.npy', result)
