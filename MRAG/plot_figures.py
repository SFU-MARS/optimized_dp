...
value1v1 = np.load('MRAG/1v1AttackDefend_speed2.npy')  # grid = 45
# value2v1 = np.load('MRAG/2v1AttackDefend.npy')
value2v1 = np.load('2v1AttackDefend_speed2.npy')
...
# 2v1 simulation
# initial positions
attackers = [(-0.1, 0.5), (-1.0, -1.0)]  # [(-0.5, 0.0), (0.0, 0.8)], [(-0.5, 0.5), (-0.3, -0.8)]
defenders = [(-0.1, 0.0)] # [(0.3, -0.3)], [(0.0, 0.0)]
a1x = attackers[0][0]
a1y = attackers[0][1]
a2x = attackers[1][0]
a2y = attackers[1][1]
