...
import numpy as np
from odp.Plots.plotting_utilities import plot_2d, plot_game, plot_original, plot_game0
...
# 2v1 simulation
# initial positions
attackers = [(-0.5, 0.5), (-0.3, -0.8)]  # [(0.0, 0.0), (0.0, 0.8), (-0.5, 0.0), (0.5, -0.5), (-0.5, -0.3), (0.8, -0.5)]
defenders = [(0.0, 0.0)] # [(0.3, 0.5), (-0.3, -0.5)]
a1x = attackers[0][0]
a1y = attackers[0][1]
a2x = attackers[1][0]
a2y = attackers[1][1]
...
plot_game(grids1v1, value_function1v1, attackers_plot1, defenders_plot1)
# plot_game0(grids1v1, value_function1v1, attackers_plot1, defenders_plot1)

# plot 2v1 reach-avoid set
jointstates2v1 = (a1x, a1y, a2x, a2y, d1x, d1y)
a1x_slice, a1y_slice, a2x_slice, a2y_slice, d1x_slice, d1y_slice = lo2slice2v1(jointstates2v1, slices=36)
...
# plot_game(grid2v1, value_function2v1, attackers_plot2, defenders_plot2)
plot_game0(grid2v1, value_function2v1, attackers_plot2, defenders_plot2)
