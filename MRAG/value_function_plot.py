...
# # 1 vs. 2 simulation
# initial positions
attackers_initials = [(-0.3, 0.0)] # 
defenders_initials = [(-0.8, 0.5), (-0.8, -0.5)]  #  [(-0.8, -0.8), (-0.8, 0.3)]  #  [(-0.8, -0.3)]
...
ax_slice_1v1_1, ay_slice_1v1_1, d1x_slice_1v1_1, d1y_slice_1v1_1 = lo2slice1v1(jointstates1v1_1, slices=45)
ax_slice_1v1_2, ay_slice_1v1_2, d2x_slice_1v1_2, d2y_slice_1v1_2 = lo2slice1v1(jointstates1v1_2, slices=45)
value_function1v1_1 = value1v1[:, :, d1x_slice_1v1_1, d1y_slice_1v1_1]
print(f"The initial value function between the attacker and teh defender 1 is {value1v1[ax_slice_1v1_1, ay_slice_1v1_1, d1x_slice_1v1_1, d1y_slice_1v1_1]}. \n")
value_function1v1_2 = value1v1[:, :, d2x_slice_1v1_2, d2y_slice_1v1_2]
print(f"The initial value function between the attacker and teh defender 2 is {value1v1[ax_slice_1v1_2, ay_slice_1v1_2, d2x_slice_1v1_2, d2y_slice_1v1_2]}. \n")
