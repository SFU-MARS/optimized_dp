...
value2v1 = value2v1[..., np.newaxis]  # value2v1.shape = [30, 30, 30, 30, 30, 30, 1]
...
for _ in range(0, times):
    ...
    print(f"The current captured attackers are {stops}. \n")
    # check new captured status of all attackers
    new_captured = capture_check1(current_attackers, current_defenders, selected)
    ...
    if check_status(current_captured, new_captured):
        ...
        MIP.append(selected)  # document the capture results
        # update the captured status of attackers
        current_captured = new_captured
        print(f"The new captured status of attackers is {new_captured}. \n")
    ...
    newa_positions = next_positions_a2(current_attackers, control_attackers, deltat, stops)  # , current_captured
...
print(f"The results of the selected is {MIP}. \n")

plot_simulation(attackers_x, attackers_y, defenders_x, defenders_y)
print(f"The captured_list of all attackers is {captured_lists}. \n")
