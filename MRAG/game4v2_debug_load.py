...
agents_1v0 = AttackerDefender1v0(uMode="min", dMode="max")  # 1v0 (2 dims dynamics)
...
capture_decisions = []
# add initial positions into the current states
...
for _ in range(0, times):
    ...
    for j in range(num_defender):
        ...
        else:  # defender j could not capture any of attackers, what control should the defender use???
