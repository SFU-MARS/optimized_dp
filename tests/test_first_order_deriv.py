...
from odp.spatialDerivatives.first_orderENO3D import spa_derivX, spa_derivY, spa_derivT
...
def test_heterocl_spa_deriv_3d():
    ...
    def hcl_spa_deriv_3d_schedule(hcl_deriv, hcl_V, hcl_index):
        with hcl.Stage("Calculate Derivative"):
            ...
            dV_dx_L, dV_dx_R = spa_derivX(hcl_i, hcl_j, hcl_k, hcl_V, grid)
            dV_dy_L, dV_dy_R = spa_derivY(hcl_i, hcl_j, hcl_k, hcl_V, grid)
            dV_dT_L, dV_dT_R = spa_derivT(hcl_i, hcl_j, hcl_k, hcl_V, grid)
...
def test_heterocl_spa_deriv_4d():
    ...
    def hcl_spa_deriv_4d_schedule(hcl_deriv, hcl_V, hcl_index):
        with hcl.Stage("Calculate Derivative"):
            ...
            dV_dx1_L, dV_dx1_R = spa_derivX1_4d(hcl_i, hcl_j, hcl_k, hcl_l, hcl_V, grid)
            dV_dx2_L, dV_dx2_R = spa_derivX2_4d(hcl_i, hcl_j, hcl_k, hcl_l, hcl_V, grid)
            dV_dx3_L, dV_dx3_R = spa_derivX3_4d(hcl_i, hcl_j, hcl_k, hcl_l, hcl_V, grid)
            dV_dx4_L, dV_dx4_R = spa_derivX4_4d(hcl_i, hcl_j, hcl_k, hcl_l, hcl_V, grid)
...
def test_heterocl_spa_deriv_5d():
    ...
    def hcl_spa_deriv_5d_schedule(hcl_deriv, hcl_V, hcl_index):
        with hcl.Stage("Calculate Derivative"):
            ...
            dV_dx1_L, dV_dx1_R = spa_derivX1_5d(
                hcl_i, hcl_j, hcl_k, hcl_l, hcl_m, hcl_V, grid
            )
            dV_dx2_L, dV_dx2_R = spa_derivX2_5d(
                hcl_i, hcl_j, hcl_k, hcl_l, hcl_m, hcl_V, grid
            )
            dV_dx3_L, dV_dx3_R = spa_derivX3_5d(
                hcl_i, hcl_j, hcl_k, hcl_l, hcl_m, hcl_V, grid
            )
            dV_dx4_L, dV_dx4_R = spa_derivX4_5d(
                hcl_i, hcl_j, hcl_k, hcl_l, hcl_m, hcl_V, grid
            )
            dV_dx5_L, dV_dx5_R = spa_derivX5_5d(
                hcl_i, hcl_j, hcl_k, hcl_l, hcl_m, hcl_V, grid
            )
...
def test_heterocl_spa_deriv_6d():
    ...
    def hcl_spa_deriv_6d_schedule(hcl_deriv, hcl_V, hcl_index):
        with hcl.Stage("Calculate Derivative"):
            ...
            dV_dx1_L, dV_dx1_R = spa_derivX1_6d(
                hcl_i, hcl_j, hcl_k, hcl_l, hcl_m, hcl_n, hcl_V, grid
            )
            dV_dx2_L, dV_dx2_R = spa_derivX2_6d(
                hcl_i, hcl_j, hcl_k, hcl_l, hcl_m, hcl_n, hcl_V, grid
            )
            dV_dx3_L, dV_dx3_R = spa_derivX3_6d(
                hcl_i, hcl_j, hcl_k, hcl_l, hcl_m, hcl_n, hcl_V, grid
            )
            dV_dx4_L, dV_dx4_R = spa_derivX4_6d(
                hcl_i, hcl_j, hcl_k, hcl_l, hcl_m, hcl_n, hcl_V, grid
            )
            dV_dx5_L, dV_dx5_R = spa_derivX5_6d(
                hcl_i, hcl_j, hcl_k, hcl_l, hcl_m, hcl_n, hcl_V, grid
            )

            dV_dx6_L, dV_dx6_R = spa_derivX6_6d(
                hcl_i, hcl_j, hcl_k, hcl_l, hcl_m, hcl_n, hcl_V, grid
            )
