"""
5-D Markov Decision Process example for OptimizedDP value iteration.

Run with::

    python -m odp.MDP_example.Example_5D

See :mod:`odp.MDP_example.Example_3D` for a description of the value-iteration
interface.  This is the reach-avoid template in five dimensions.
"""
...
def main():
    ...
    grid = Grid(minBounds=mdp.bounds[:, 0], maxBounds=mdp.bounds[:, 1],
                dims=_DIMS, pts_each_dim=np.array([11] * _DIMS))
