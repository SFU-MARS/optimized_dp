...
def graph_8D(my_object, g, compMethod, accuracy):
	...
	x7 = hcl.placeholder((g.pts_each_dim[7],), name="x7", dtype=hcl.Float())

	def graph_create(V_new, V_init, x0, x1, x2, x3, x4, x5, x6, x7, t, l0):
		...
		# deriv_diff7 = hcl.compute(V_init.shape, lambda *x: 0, "deriv_diff7")

		# max_deriv0 = hcl.scalar(-1e9, "max_deriv0")
		...
		# max_deriv7 = hcl.scalar(-1e9, "max_deriv7")
		...
		# min_deriv7 = hcl.scalar(1e9, "min_deriv7")

		# max_alpha0 = hcl.scalar(-1e9, "max_alpha0")
		...
		# max_alpha7 = hcl.scalar(-1e9, "max_alpha7")
		...
		max_alpha7 = hcl.scalar(my_object.speed_d, "max_alpha7")

		def step_bound(): #Function to calculate time step
			stepBoundInv = hcl.scalar(0, "stepBoundInv")
			stepBound = hcl.scalar(0, "stepBound")
			stepBoundInv[0] = max_alpha0[0] / g.dx[0]+ max_alpha1[0] / g.dx[1]+ max_alpha2[0] / g.dx[2]+ max_alpha3[0] / g.dx[3]+ max_alpha4[0] / g.dx[4]+ max_alpha5[0] / g.dx[5]+ max_alpha6[0] / g.dx[6]+ max_alpha7[0] / g.dx[7]
		...
		def minVWithVInit(i0, i1, i2, i3, i4, i5, i6, i7):
			with hcl.if_(V_new[i0, i1, i2, i3, i4, i5, i6, i7] > V_init[i0, i1, i2, i3, i4, i5, i6, i7]):
				V_new[i0, i1, i2, i3, i4, i5, i6, i7] = V_init[i0, i1, i2, i3, i4, i5, i6, i7]
		def maxVWithVInit(i0, i1, i2, i3, i4, i5, i6, i7):
			with hcl.if_(V_new[i0, i1, i2, i3, i4, i5, i6, i7] < V_init[i0, i1, i2, i3, i4, i5, i6, i7]):
				V_new[i0, i1, i2, i3, i4, i5, i6, i7] = V_init[i0, i1, i2, i3, i4, i5, i6, i7]
		def maxVWithV0(i0, i1, i2, i3, i4, i5, i6, i7):
			with hcl.if_(V_new[i0, i1, i2, i3, i4, i5, i6, i7] < l0[i0, i1, i2, i3, i4, i5, i6, i7]):
				V_new[i0, i1, i2, i3, i4, i5, i6, i7] = l0[i0, i1, i2, i3, i4, i5, i6, i7]
		def minVWithV0(i0, i1, i2, i3, i4, i5, i6, i7):
			with hcl.if_(V_new[i0, i1, i2, i3, i4, i5, i6, i7] > l0[i0, i1, i2, i3, i4, i5, i6, i7]):
				V_new[i0, i1, i2, i3, i4, i5, i6, i7] = l0[i0, i1, i2, i3, i4, i5, i6, i7]
							...
							with hcl.for_(0, V_init.shape[4], name="i4") as i4:
								with hcl.for_(0, V_init.shape[5], name="i5") as i5:
									with hcl.for_(0, V_init.shape[6], name="i6") as i6:
										with hcl.for_(0, V_init.shape[7], name="i7") as i7:
											...
											dV_dx_L7 = hcl.scalar(0, "dV_dx_L7")
											dV_dx_R7 = hcl.scalar(0, "dV_dx_R7")
											dV_dx7 = hcl.scalar(0, "dV_dx7")
											if accuracy == "low":
												dV_dx_L0[0], dV_dx_R0[0] = spa_derivX0_8d(i0, i1, i2, i3, i4, i5, i6, i7, V_init, g)
												dV_dx_L1[0], dV_dx_R1[0] = spa_derivX1_8d(i0, i1, i2, i3, i4, i5, i6, i7, V_init, g)
												dV_dx_L2[0], dV_dx_R2[0] = spa_derivX2_8d(i0, i1, i2, i3, i4, i5, i6, i7, V_init, g)
												dV_dx_L3[0], dV_dx_R3[0] = spa_derivX3_8d(i0, i1, i2, i3, i4, i5, i6, i7, V_init, g)
												dV_dx_L4[0], dV_dx_R4[0] = spa_derivX4_8d(i0, i1, i2, i3, i4, i5, i6, i7, V_init, g)
											...
											# deriv_diff3[i0, i1, i2, i3, i4, i5, i6, i7] = dV_dx_R3[0] - dV_dx_L3[0]
											# deriv_diff4[i0, i1, i2, i3, i4, i5, i6, i7] = dV_dx_R4[0] - dV_dx_L4[0]
											# deriv_diff5[i0, i1, i2, i3, i4, i5, i6, i7] = dV_dx_R5[0] - dV_dx_L5[0]
											# deriv_diff6[i0, i1, i2, i3, i4, i5, i6, i7] = dV_dx_R6[0] - dV_dx_L6[0]
											# deriv_diff7[i0, i1, i2, i3, i4, i5, i6, i7] = dV_dx_R7[0] - dV_dx_L7[0]
											...
											deriv_diff7 = hcl.scalar(0, "deriv_diff7")
											...
											deriv_diff7[0] = dV_dx_R7[0] - dV_dx_L7[0]
											...
											dV_dx7[0] = (dV_dx_L7 + dV_dx_R7) / 2
											uOpt = my_object.opt_ctrl(t, (x0[i0], x1[i1], x2[i2], x3[i3], x4[i4], x5[i5], x6[i6], x7[i7]),
 (dV_dx0[0], dV_dx1[0], dV_dx2[0], dV_dx3[0], dV_dx4[0], dV_dx5[0], dV_dx6[0], dV_dx7[0]))
											dOpt = my_object.opt_dstb(t, (x0[i0], x1[i1], x2[i2], x3[i3], x4[i4], x5[i5], x6[i6], x7[i7]),
 (dV_dx0[0], dV_dx1[0], dV_dx2[0], dV_dx3[0], dV_dx4[0], dV_dx5[0], dV_dx6[0], dV_dx7[0]))
											dx_dt0, dx_dt1, dx_dt2, dx_dt3, dx_dt4, dx_dt5, dx_dt6, dx_dt7 = my_object.dynamics(t, (x0[i0], x1[i1], x2[i2], x3[i3], x4[i4], x5[i5], x6[i6], x7[i7]), uOpt, dOpt)
											V_new[i0, i1, i2, i3, i4, i5, i6, i7] = -(dx_dt0 * dV_dx0[0] + dx_dt1 * dV_dx1[0] + dx_dt2 * dV_dx2[0] + dx_dt3 * dV_dx3[0] + dx_dt4 * dV_dx4[0] + dx_dt5 * dV_dx5[0] + dx_dt6 * dV_dx6[0] + dx_dt7 * dV_dx7[0])
											...
											alpha7 = hcl.scalar(my_object.speed_d, "alpha8")
											...
											diss[0] = 0.5 * (deriv_diff0[0] * alpha0[0] + deriv_diff1[0] * alpha1[0] + deriv_diff2[0] * alpha2[0] \
														 ...
														 + deriv_diff7[0] * alpha7[0])
											
											# Finally
											V_new[i0, i1, i2, i3, i4, i5, i6, i7] = -(V_new[i0, i1, i2, i3, i4, i5, i6, i7] - diss[0])
											...
											# with hcl.if_(dV_dx_L7[0] < min_deriv7[0]):
											# 	min_deriv7[0] = dV_dx_L7[0]
											# with hcl.if_(dV_dx_L7[0] > max_deriv7[0]):
											# 	max_deriv7[0] = dV_dx_L7[0]
											# with hcl.if_(dV_dx_R7[0] < min_deriv7[0]):
											# 	min_deriv7[0] = dV_dx_R7[0]
											# with hcl.if_(dV_dx_R7[0] > max_deriv7[0]):
											# 	max_deriv7[0] = dV_dx_R7[0]
...
# 											alpha7[0] = my_max(alpha7[0], dx_UU7[0])
# 											diss = hcl.scalar(0, "diss")
# 											diss[0] = 0.5 * (deriv_diff0[i0, i1, i2, i3, i4, i5, i6, i7] * alpha0[0] + deriv_diff1[i0, i1, i2, i3, i4, i5, i6, i7] * alpha1[0] + deriv_diff2[i0, i1, i2, i3, i4, i5, i6, i7] * alpha2[0] + deriv_diff3[i0, i1, i2, i3, i4, i5, i6, i7] * alpha3[0] + deriv_diff4[i0, i1, i2, i3, i4, i5, i6, i7] * alpha4[0] + deriv_diff5[i0, i1, i2, i3, i4, i5, i6, i7] * alpha5[0] + deriv_diff6[i0, i1, i2, i3, i4, i5, i6, i7] * alpha6[0] + deriv_diff7[i0, i1, i2, i3, i4, i5, i6, i7] * alpha7[0])
# 											V_new[i0, i1, i2, i3, i4, i5, i6, i7] = -(V_new[i0, i1, i2, i3, i4, i5, i6, i7] - diss[0])
...
# 											with hcl.if_(alpha7[0] > max_alpha7[0]):
# 												max_alpha7[0] = alpha7[0]
		delta_t = hcl.compute((1,), lambda x: step_bound(), name="delta_t")
		result = hcl.update(V_new, lambda i0, i1, i2, i3, i4, i5, i6, i7: V_init[i0, i1, i2, i3, i4, i5, i6, i7] + V_new[i0, i1, i2, i3, i4, i5, i6, i7] * delta_t[0])
		if compMethod == 'maxVWithV0' or compMethod == 'maxVWithVTarget':
			result = hcl.update(V_new, lambda i0, i1, i2, i3, i4, i5, i6, i7:  maxVWithV0(i0, i1, i2, i3, i4, i5, i6, i7))
		if compMethod == 'minVWithV0' or compMethod == 'minVWithVTarget':
			result = hcl.update(V_new, lambda i0, i1, i2, i3, i4, i5, i6, i7:  minVWithV0(i0, i1, i2, i3, i4, i5, i6, i7))
		if compMethod == 'maxVWithVInit' :
			result = hcl.update(V_new, lambda i0, i1, i2, i3, i4, i5, i6, i7:  maxVWithVInit(i0, i1, i2, i3, i4, i5, i6, i7))
		if compMethod == 'minVWithVInit' :
			result = hcl.update(V_new, lambda i0, i1, i2, i3, i4, i5, i6, i7:  minVWithVInit(i0, i1, i2, i3, i4, i5, i6, i7))
		hcl.update(V_init, lambda i0, i1, i2, i3, i4, i5, i6, i7:  V_new[i0, i1, i2, i3, i4, i5, i6, i7])
		return result
	s = hcl.create_schedule([V_f, V_init, x0, x1, x2, x3, x4, x5, x6, x7, t, l0], graph_create)
	#Optimizing
