...
from odp.spatialDerivatives.secondOrderENO.second_orderENO7D import *
from odp.spatialDerivatives.firstOrderENO.first_orderENO7D import *

########################## 7D graph definition ######################## 
def graph_7D(my_object, g, compMethod, accuracy, generate_SpatDeriv=False, deriv_dim=1):
	...
	def graph_create(V_new, V_init, x0, x1, x2, x3, x4, x5, x6, delta_t, t, l0):
							...
							with hcl.for_(0, V_init.shape[4], name="i4") as i4:
								with hcl.for_(0, V_init.shape[5], name="i5") as i5:
									with hcl.for_(0, V_init.shape[6], name="i6") as i6:
										...
										if accuracy == "medium":
											dV_dx_L0[0], dV_dx_R0[0] = secondOrder_ENO7D_X0(i0, i1, i2, i3, i4, i5, i6, V_init, g)
											dV_dx_L1[0], dV_dx_R1[0] = secondOrder_ENO7D_X1(i0, i1, i2, i3, i4, i5, i6, V_init, g)
											dV_dx_L2[0], dV_dx_R2[0] = secondOrder_ENO7D_X2(i0, i1, i2, i3, i4, i5, i6, V_init, g)
											dV_dx_L3[0], dV_dx_R3[0] = secondOrder_ENO7D_X3(i0, i1, i2, i3, i4, i5, i6, V_init, g)
											dV_dx_L4[0], dV_dx_R4[0] = secondOrder_ENO7D_X4(i0, i1, i2, i3, i4, i5, i6, V_init, g)
											dV_dx_L5[0], dV_dx_R5[0] = secondOrder_ENO7D_X5(i0, i1, i2, i3, i4, i5, i6, V_init, g)
											dV_dx_L6[0], dV_dx_R6[0] = secondOrder_ENO7D_X6(i0, i1, i2, i3, i4, i5, i6, V_init, g)
						...
						with hcl.for_(0, V_array.shape[3], name="l") as l:
							with hcl.for_(0, V_array.shape[4], name="m") as m:
								with hcl.for_(0, V_array.shape[5], name="n") as n:
									with hcl.for_(0, V_array.shape[6], name="o") as o:
										dV_dx_L = hcl.scalar(0, "dV_dx_L")
										dV_dx_R = hcl.scalar(0, "dV_dx_R")
										if accuracy == "low":
											if deriv_dim == 1:
												dV_dx_L[0], dV_dx_R[0] = spa_derivX0_7d(i, j, k, l, m, n, o, V_array, g)
											if deriv_dim == 2:
												dV_dx_L[0], dV_dx_R[0] = spa_derivX1_7d(i, j, k, l, m, n, o, V_array, g)
											if deriv_dim == 3:
												dV_dx_L[0], dV_dx_R[0] = spa_derivX2_7d(i, j, k, l, m, n, o, V_array, g)
											if deriv_dim == 4:
												dV_dx_L[0], dV_dx_R[0] = spa_derivX3_7d(i, j, k, l, m, n, o, V_array, g)
											if deriv_dim == 5:
												dV_dx_L[0], dV_dx_R[0] = spa_derivX4_7d(i, j, k, l, m, n, o, V_array, g)
											if deriv_dim == 6:
												dV_dx_L[0], dV_dx_R[0] = spa_derivX5_7d(i, j, k, l, m, n, o, V_array, g)
											if deriv_dim == 7:
												dV_dx_L[0], dV_dx_R[0] = spa_derivX6_7d(i, j, k, l, m, n, o, V_array, g)

										if accuracy == "medium":
											if deriv_dim == 1:
												dV_dx_L[0], dV_dx_R[0] = secondOrder_ENO7D_X0(i, j, k, l, m, n, o, V_array, g)
											if deriv_dim == 2:
												dV_dx_L[0], dV_dx_R[0] = secondOrder_ENO7D_X1(i, j, k, l, m, n, o, V_array, g)
											if deriv_dim == 3:
												dV_dx_L[0], dV_dx_R[0] = secondOrder_ENO7D_X2(i, j, k, l, m, n, o, V_array, g)
											if deriv_dim == 4:
												dV_dx_L[0], dV_dx_R[0] = secondOrder_ENO7D_X3(i, j, k, l, m, n, o, V_array, g)
											if deriv_dim == 5:
												dV_dx_L[0], dV_dx_R[0] = secondOrder_ENO7D_X4(i, j, k, l, m, n, o, V_array, g)
											if deriv_dim == 6:
												dV_dx_L[0], dV_dx_R[0] = secondOrder_ENO7D_X5(i, j, k, l, m, n, o, V_array, g)
											if deriv_dim == 7:
												dV_dx_L[0], dV_dx_R[0] = secondOrder_ENO7D_X6(i, j, k, l, m, n, o, V_array, g)

										Deriv_array[i, j, k, l, m, n, o] = (dV_dx_L[0] + dV_dx_R[0]) / 2

	if generate_SpatDeriv == False:
		s = hcl.create_schedule([V_f, V_init, x0, x1, x2, x3, x4, x5, x6, delta_t, t, l0], graph_create)
		#Optimizing
