...
def updatePhi(i, j, k, my_object, phi, constraint, g, x1, x2, x3):
                ...
                with hcl.for_(l_i, h_i, name="i") as i:
                    with hcl.for_(l_j, h_j, name="j") as j:
                        with hcl.for_(l_k, h_k, name="k") as k:
                            updatePhi(i, j, k, my_object, phi, constraint, g, x1, x2, x3)
                            # debug2[0] = j
                ...
                with hcl.for_(l_i, h_i, name="i") as i:
                    with hcl.for_(l_j, h_j, name="j") as j:
                        with hcl.for_(l_k, h_k, name="k") as k:
                            ...
                            j2 = phi.shape[1] - j - 1
                            k2 = phi.shape[2] - k - 1
                            updatePhi(i2, j2, k2, my_object, phi, constraint, g, x1, x2, x3)
                EvalBoundary(phi, constraint, g)
                ...
                with hcl.for_(l_i, h_i, name="i") as i:
                    with hcl.for_(l_j, h_j, name="j") as j:
                        with hcl.for_(l_k, h_k, name="k") as k:
                            j2 = phi.shape[1] - j - 1
                            k2 = phi.shape[2] - k - 1
                            updatePhi(i, j2, k2, my_object, phi, constraint, g, x1, x2, x3)
                EvalBoundary(phi, constraint, g)
                ...
                with hcl.for_(l_i, h_i, name="i") as i:
                    with hcl.for_(l_j, h_j, name="j") as j:
                        with hcl.for_(l_k, h_k, name="k") as k:
                            i2 = phi.shape[0] - i - 1
                            j2 = phi.shape[1] - j - 1
                            updatePhi(i2, j2, k, my_object, phi, constraint, g, x1, x2, x3)
                EvalBoundary(phi, constraint, g)
                ...
                with hcl.for_(l_i, h_i, name="i") as i:
                    with hcl.for_(l_j, h_j, name="j") as j:
                        with hcl.for_(l_k, h_k, name="k") as k:
                            i2 = phi.shape[0] - i - 1
                            k2 = phi.shape[2] - k - 1
                            updatePhi(i2, j, k2, my_object, phi, constraint, g, x1, x2, x3)
                EvalBoundary(phi, constraint, g)
            ...
            with hcl.Stage("Sweep_6"):
                with hcl.for_(l_i, h_i, name="i") as i:
                    with hcl.for_(l_j, h_j, name="j") as j:
                        with hcl.for_(l_k, h_k, name="k") as k:
                            i2 = phi.shape[0] - i - 1
                            updatePhi(i2, j, k, my_object, phi, constraint, g, x1, x2, x3)
                EvalBoundary(phi, constraint, g)
            ...
            with hcl.Stage("Sweep_7"):
                with hcl.for_(l_i, h_i, name="i") as i:
                    with hcl.for_(l_j, h_j, name="j") as j:
                        with hcl.for_(l_k, h_k, name="k") as k:
                            j2 = phi.shape[1] - j - 1
                            updatePhi(i, j2, k, my_object, phi, constraint, g, x1, x2, x3)
                EvalBoundary(phi, constraint, g)
            ...
            with hcl.Stage("Sweep_8"):
                with hcl.for_(l_i, h_i, name="i") as i:
                    with hcl.for_(l_j, h_j, name="j") as j:
                        with hcl.for_(l_k, h_k, name="k") as k:
                            k2 = phi.shape[2] - k - 1
                            updatePhi(i, j, k2, my_object, phi, constraint, g, x1, x2, x3)
                EvalBoundary(phi, constraint, g)
