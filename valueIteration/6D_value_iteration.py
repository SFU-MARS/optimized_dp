...
def transition(sVals, action, bounds, trans, goal):
    ...
    with hcl.else_():
        trans[0, 0] = 1.0
        trans[0, 1] = sVals[1] + action[1]
        trans[0, 2] = sVals[2] + action[2]
        trans[0, 3] = sVals[3] + action[3]
        trans[0, 4] = sVals[4] + action[4]  
        trans[0, 5] = sVals[5] + action[5]  
        trans[0, 6] = sVals[6] + action[6]  
