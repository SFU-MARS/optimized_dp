...
def plot_contour(V_slice, selected_slice, xmin, xmax, ymin, ymax, grid1, grid2):
    ...
    contour = plt.contour(V_slice, levels=levels, cmap='rainbow', linewidths=3.0)
...
V_slice = V_0_Dev[:, :, selected_slice]
plot_contour(V_slice, selected_slice, -6.5, 21.5, -13, -1.5, 561, 231)
